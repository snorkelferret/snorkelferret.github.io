...
;(function () {
    ...
    ApocoMakeForm.prototype = {
        _execute: function _execute() {
            ...
            this.element.classList.add("apoco_form");
        ...
        addSubmitter: function addSubmitter(index, el, parent_element) {
            var n = {},
                p,
                d;
...
;(function () {
    ...
    ApocoMakeGrid.prototype = {
        ...
        findRow: function findRow(e, self) {
            var el,
                n,
                r = {};
        ...
        setCellHeatMap: function setCellHeatMap(cell) {
            var cell_el, cl, to;
            if (cell.hidden !== true) {
                cl = "cell_updated";
...
;(function () {
    ...
    FileField.prototype = {
        _promises: [],
        _errors: [],
        _mkInputNode: function _mkInputNode() {
            var q,
                p,
                that = this;
        ...
        _addInputListener: function _addInputListener() {
            var that = this,
                rc;
        ...
        _processFileIn: function _processFileIn() {
            var that = this;
        ...
        _handleEvent: function _handleEvent(that) {
            return function (e) {
                switch (e.type) {
                    case "dragover":
        ...
        clearFileNames: function clearFileNames() {
            if (this._files) {
        ...
        mkFileDisplay: function mkFileDisplay(v) {
            var that = this;
...
;(function () {
    ...
    Apoco.IO = {
        ...
        getFiles: function getFiles(f, that) {
            var promise,
                found = false;
            if (!that) {
...
},{"base64-js":21,"ieee754":28}],23:[function(require,module,exports){
'use strict';
...
},{"for-own":27,"is-plain-object":31,"kind-of":33,"lazy-cache":34,"shallow-clone":38}],25:[function(require,module,exports){
...
},{"is-buffer":29}],34:[function(require,module,exports){
(function (process){
'use strict';
...
},{"for-in":36,"is-extendable":30}],36:[function(require,module,exports){
...
},{"buffer":22,"is-buffer":29}],40:[function(require,module,exports){
(function (process){
'use strict';
...
},{"is-extendable":30,"kind-of":39,"lazy-cache":40,"mixin-object":35}]},{},[20]);
